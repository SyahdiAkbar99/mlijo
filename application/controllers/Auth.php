...
class Auth extends CI_Controller
{
    ...
    public function registration_user_admin()
    {
        // ========================================
        if ($this->session->userdata('email_user')) {
            //astagfirullah ternyata bisa digunain pas pakek form 403 Access Forbidden kodingan kek gini :(
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data = [
                'id_akses' => 1,
                'nama_user' => htmlspecialchars($this->input->post('name_user', true)),
            ...
            if ($true == true) {
                ...
                redirect('Auth/registration_user_admin');
            }
        }
    }
    ...
    // public function registration_pembeli()
    // {
    ...
    // public function registration_penjual()
    // {
